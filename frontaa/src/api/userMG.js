...
export const carNoCheck = (params) => { return loginreq("post", "/api/baidu", params) };
// 登录接口
...
export const testLink =()=>{return axios.get("")}
/**
 * 用户管理
 **/
// 用户管理-获取用户列表
export const userList = (params) => { return req("post", "/api/getOwnerList", params) };
export const userallList = (params) => { return req("post", "/api/getrepairname", params) };
//用户保存
export const changeUserPwd = (params)=>{return req("post","/api/updateOwenerPwd",params)};


// 用户管理-保存（添加编辑）
export const userSave = (params) => { return req("post", "/api/updateOwner", params) };
//用户修改密码
export const userUpdate = (params) => { return req("post", "/api/property/update", params) };
 ...
 **/
// 车位管理
export const parikingList = (params) => { return req("post", "/api/parking/getList", params) };
// 角色管理-获取角色列表
export const carInOutList = (params) => { return req("post", "/api/car/getCarInOutList", params) };
// 角色管理-保存（添加编辑）
export const roleSave = (params) => { return req("post", "/api/parking/update", params) };
// 角色管理-删除角色
 ...
 * 留言管理
 **/
export const wordSList = (params) => { return req("post", "/api/words/getList", params) };
export const WordsDelete = (params) => { return axios.delete("/api/words/deleteWords?id=" + params ).then(res => res.data) };
export const wordSubmit = (params) => { return req("post", "/api/words/insertword", params) };
export const SingleUserWord = (params) => { return req("post", "/api/words/getsingleWord", params) };
export const repairSave = (params) => { return req("post", "/api/repair/insertrepair", params) };
export const repairList = (params) => { return req("post", "/api/repair/getList", params) };
export const repairdelete = (params) => { return req("post", "/api/repair/deleterepair", params) };
export const repanameList = (params) => { return req("post", "/api/repair/getbynameList", params) };
export const repairhandle = (params) => { return req("post", "/api/repair/repairhandle", params) };


//车辆进出小区
export const carIn = (params) => { return req("post", "/api/car/carIn", params) };
export const carOut = (params) => { return req("post", "/api/car/carOut", params) };
